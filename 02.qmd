...
| Fine focus | (i) The knob that makes small adjustments in the mechanical stage. |
...
| Base | (c) The microscope supports. |
| Objective lens | (f) The major lenses closest to the specimen. |
| Coarse focus | (h) Knob that makes large scale adjustments in the focus. |
