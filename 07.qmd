...
## Axial Skeleton – Key Terms

-   Axial skeleton **skull, vertebral column, and thoracic cage; supports and protects vital organs**

-   Cranial bones **bones of the skull that protect the brain**

-   Facial bones **bones that form the face and support facial structures**

-   Suture **immovable joint between skull bones**

-   Hyoid bone **U-shaped bone in the neck that supports the tongue**

-   Vertebrae **bones that form the spinal column and protect the spinal cord**

    -   Cervical **neck vertebrae (C1–C7)**
    -   Thoracic **mid-back vertebrae attached to ribs (T1–T12)**
    -   Lumbar **lower back vertebrae (L1–L5)**
    -   Sacrum **fused vertebrae forming back of pelvis**
    -   Coccyx **tailbone; small fused vertebrae** \## **Prelab Activity 7.2:**
...
| Bone Name             | Bone Shape Classification | Axial or Appendicular |
|-----------------------|---------------------------|-----------------------|
| Facial bone (maxilla) | Irregular                 | Axial                 |
| Thoracic vertebra     | Irregular                 | Axial                 |
| Scapula               | Flat                      | Appendicular          |
| Radius                | Long                      | Appendicular          |
| Tarsal bones          | Short                     | Appendicular          |
| Phalanges             | Long                      | Appendicular          |
| Ribs                  | Flat                      | Axial                 |
...
## Figure 7.36 – Bone Anatomy Crossword

### Across

-   5 Foramen magnum\
-   8 Sinus\
-   10 Parietal and occipital\
-   11 Maxilla\
-   12 Frontal and parietal
