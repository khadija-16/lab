...
|---|---|---|
| a) | The bones of the skull, rib cage, and vertebral column make up the __________ skeleton. | axial |
| b) | Articular cartilage is composed of __________. | hyaline cartilage |
| c) | The line separating diaphysis and epiphysis is the __________. | epiphyseal line |
| d) | Articular cartilage covers ends of long bones. | Articular |
| e) | Skeletal cartilage is enclosed by the __________. | perichondrium |
| f) | The tubular shaft of long bones is called the __________. | diaphysis |
| g) | __________ is found in the central (medullary) cavity of an adult's long bones and is composed of fat. | Yellow marrow |
| h) | The bones of the limbs, shoulders, and hips make up the __________ skeleton. | appendicular |
| i) | Cancellous bone is found in the __________ of long bones. | epiphyses |
| j) | The inner surface of the bone is covered by the __________. | endosteum |
