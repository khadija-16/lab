...
-   Axial skeleton **skull, vertebral column, and thoracic cage; supports and protects organs**\
-   Appendicular skeleton **limbs and girdles; allows movement**
...
-   Diaphysis **shaft of bone; contains compact bone**\
-   Compact bone **dense outer layer for strength**\
-   Spongy bone **porous inner bone with marrow**\
-   Hyaline (articular) cartilage **reduces friction at joints**\
-   Periosteum **outer covering; blood supply and growth**\
-   Bone processes **projections for muscle attachment**\
-   Medullary cavity **hollow center of diaphysis**\
-   Yellow marrow **fat storage**\
-   Red marrow **blood cell production**\
-   Epiphyseal plate **growth plate for lengthening**\
-   Endosteum (simple squamous) **inner lining of bone cavity**
...
| Matrix            | Hard material surrounding cells  |
| Collagen fibers   | Provide flexibility and strength |
| Calcium phosphate | Provides hardness                |
...
| Flat bones     | Thin and flat (e.g., skull)         |
...
| 8      | Humerus                | Appendicular                |
| 9      | Radius                 | Appendicular                |
| 10     | Ulna                   | Appendicular                |
| 11     | Carpals                | Appendicular                |
| 12     | Metacarpals            | Appendicular                |
| 13     | Phalanges (hand)       | Appendicular                |
| 14     | Pelvis (hip bone)      | Appendicular                |
| 15     | Sacrum                 | Axial                       |
| 16     | Femur                  | Appendicular                |
| 17     | Patella                | Appendicular                |
| 18     | Tibia                  | Appendicular                |
| 19     | Fibula                 | Appendicular                |
| 20     | Tarsals                | Appendicular                |
| 21     | Metatarsals            | Appendicular                |
| 22     | Phalanges (foot)       | Appendicular                |
| 23     | Coccyx                 | Axial                       |
| 26     | Vertebrae              | Axial                       |
...
Classify the following bones based their location in the major division they are found (axial or appendicular): \## Bone Classification
...
## Bone Features Identification Activity

| Task | Answer |
|---|---|
| Materials used | Disarticulated bones or articulated skeleton |
| Purpose of activity | Locate and identify bone features from Table 6.2 |
| How to label identified features | Use tape labels |
| Who confirms identification first | Group mates |
| Final confirmation | Instructor |
...
| Flat | Thin and wide; curved | Sternum, ribs, scapula |
| Irregular | Complex shape | Vertebrae, coxal bones |
| Sesamoid | Seed shaped; small and round | Patella |
...
## Bone Microstructure Crossword

### Across

-   6 Osteons, central canal\
-   7 Perforating canal
...
## Skeletal System Matching
## Skeletal System Matching

| Answer | Statement | Term(s) |
|---|---|---|
| a) | The bones of the skull, rib cage, and vertebral column make up the axial skeleton. | axial |
| b) | Articular cartilage is composed of hyaline cartilage. | hyaline cartilage |
| c) | The line separating diaphysis and epiphysis is the epiphyseal line. | epiphyseal line |
| d) | Articular cartilage covers ends of long bones. | articular |
| e) | Skeletal cartilage is enclosed by the perichondrium. | perichondrium |
| f) | The tubular shaft of long bones is called the diaphysis. | diaphysis |
| g) | Yellow marrow is found in the central (medullary) cavity of an adult's long bones and is composed of fat. | yellow marrow |
| h) | The bones of the limbs, shoulders, and hips make up the appendicular skeleton. | appendicular |
| i) | Cancellous bone is found in the epiphyses of long bones. | epiphyses |
| j) | The inner surface of the bone is covered by the endosteum. | endosteum |
